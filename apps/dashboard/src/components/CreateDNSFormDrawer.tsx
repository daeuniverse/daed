...
export const CreateDNSFormDrawer = ({
  isOpen,
  onClose,
  onSubmit,
}: {
  ...
  return (
    <CreateFormDrawer<FormValues> header={t("dns")} isOpen={isOpen} onClose={onClose} form={form} onSubmit={onSubmit}>
      <Flex direction="column" gap={4}>
        ...
        <Textarea h="md" isRequired {...register("dns")} spellCheck={false} />
      </Flex>
    </CreateFormDrawer>
  );
};
